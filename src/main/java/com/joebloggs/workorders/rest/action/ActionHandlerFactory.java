...
/**
 * Factory which returns a concrete Action Handler implementation based on the operation being performed. Concrete service implementation also decided
 * here.
 */
public class ActionHandlerFactory {
    ...
    public static ActionHandler getActionHandler(final OperationDataContainer operationDataContainer) {
        ...
        final WorkOrderSchedulingService schedulingService = new WorkOrderServiceImpl();
